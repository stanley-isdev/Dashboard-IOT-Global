/**
 * Timezone helpers, ported verbatim from src/mocks/tz.ts (the mock adapter's
 * reference implementation) - this is the exact IANA-zone-aware math the real
 * backend must use for shift resolution and production-date anchoring
 * (design doc sections 7, 9.5, 9.6). Never a fixed UTC offset: section 9.6
 * records that the old dashboards' `TzOffsetHours` variable (7, 0, -5, -4, 9)
 * is wrong twice a year for the US, Hungary and Mexico sites and wrong
