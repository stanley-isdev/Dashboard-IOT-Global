...
async function fetchWindow(
  ...
  return {
    ...
    error: null,
    /*
     * Always empty here, and not for want of failures: this path splits a read
     * by TIME and the poller splits it by SITE, so what a chunk loses is hours
     * (`gaps` below) and never a plant. Every site is asked for every chunk.
     */
    siteOutages: [],
    ...folded,
    /*
