...
export const th: Dict = {
  ...
  'kpi.orderEnd.source':
    'อ่านจากใบสั่งผลิตที่แต่ละเครื่องเดินในวันนี้ ไม่ได้อ่านจากสถานะเครื่อง เพราะไม่มีเครื่องไหนส่งสถานะ “Order End” เลย · ใบสั่งจะถือว่าจบเมื่อเครื่องขึ้นใบใหม่แล้ว ซึ่งเป็นกติกาเดียวกับที่บอร์ดหน้างานใช้ตอนสร้างการ์ดใบที่สองคู่กับใบที่กำลังเดินอยู่',
